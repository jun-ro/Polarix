...
function Animation:Play(Name, transitionTime: number)
	if transitionTime then
		self.animations[Name]:Play(transitionTime)
	else
		self.animations[Name]:Play()
	end
end

function Animation:GetAnim(Name: string)
	return self.animations[Name]
end

function Animation:GetAnims()
